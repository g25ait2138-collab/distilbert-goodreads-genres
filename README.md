...
├── train.py                                 # Model loading, Trainer setup, training, W&B logging, HF push
...
├── notebook.ipynb                           # Single-cell Kaggle notebook (end-to-end run)
├── notebook.py                              # All-in-one Python script (mirror of notebook.ipynb)
├── requirements.txt                         # Pinned dependencies
├── README.md                                # You are here
├── MLOps_Assignment2_Final_Report.pdf       # Final report (PDF, 5 pages)
└── MLOps_Assignment2_Submission_Writeup.docx # Editable submission write-up (Word)
```
...
```bash
git clone https://github.com/aloksahni04/mlops-assignment2.git
...
- **Kaggle Notebook:** <https://www.kaggle.com/code/aloksahnig25ait2138/notebook8d09f3f76d>
- **Hugging Face Model:** <https://huggingface.co/ALOK2026/distilbert-goodreads-genres>
- **W&B Project Dashboard:** <https://wandb.ai/aloksahnig25ait2138-iit-jodhpur/mlops-assignment2>
- **Starter Notebook (reference):** <https://colab.research.google.com/drive/15yJsCtRu4kgqCLT44Tjhs3SFOT5GITqC?usp=sharing>
...
**Alok Sahni** — Roll No. **G25AIT2138** — PGD AI, IIT Jodhpur
